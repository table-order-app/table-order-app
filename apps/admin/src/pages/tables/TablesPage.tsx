    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="min-w-0 flex-1">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">テーブル管理</h1>
          <p className="mt-1 sm:mt-2 text-sm text-gray-700">店舗のテーブル設定とレイアウト管理を行います</p>
        </div>
