...
export async function createStaffMember(data: any) {
  return post<any>("/admin/staff", data);
}
...
export async function updateStaffMember(id: string, data: any) {
  return put<any>(`/admin/staff/${id}`, data);
}
